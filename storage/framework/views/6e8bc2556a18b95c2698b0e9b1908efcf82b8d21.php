...
<div class="card shadow mb-4">
    ...
    <table class="table table-bordered">
        ...
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(empty(request()->nome) || (strpos(strtolower($value->title), strtolower(request()->nome)) !== false)): ?>
                <tr>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Area de Trabalho\Wallpapers\cadastro\TCC\resources\views/servicos/index.blade.php ENDPATH**/ ?>