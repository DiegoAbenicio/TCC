...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Editando Cliente</h6>
    </div>
    <div class="card-body">
...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Editar um antigo Cliente</h2>
        </div>
    </div>
</div>
...
<form class ="was-validated" action ="<?php echo e(route('clientes.update',$cliente->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Area de Trabalho\Wallpapers\cadastro\TCC\resources\views/clientes/edit.blade.php ENDPATH**/ ?>